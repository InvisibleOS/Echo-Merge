...
function computeLiveScoringBreakdown(demandCount, urgency, category, existingBreakdown = null, validationScore = 0.15, validationContext = null) {
  ...
  // Use the new validation score, or if none provided, keep the existing or default to 0.15
  const validation_multiplier = existingBreakdown ? Math.max(existingBreakdown.validation_multiplier || 0, validationScore) : validationScore;
