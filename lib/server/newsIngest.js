 ...
 *
 * Tavily returns real civic news with geographic noise, so every article is run
...
/** Search-query templates for a city (kept few to bound Tavily calls). */
...
/**
 * Classify one Tavily article into a proactive-alert candidate for `city`.
