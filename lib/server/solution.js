...
const DEPARTMENT_BY_KEY = {
  water: { name: 'Bangalore Water Supply and Sewerage Board (BWSSB)', officer: 'Assistant Engineer, Water Services' },
  waste: { name: 'BBMP Solid Waste Management Wing', officer: 'Health Inspector' },
  power: { name: 'BESCOM (Bangalore Electricity Supply Company)', officer: 'Junior Engineer, Electrical' },
  roads: { name: 'Public Works Department (PWD)', officer: 'Executive Engineer' },
  safety: { name: 'Public Safety and Police Liaison', officer: 'Nodal Safety Officer' },
  general: { name: 'BBMP Ward Office', officer: 'Assistant Executive Engineer' },
};
