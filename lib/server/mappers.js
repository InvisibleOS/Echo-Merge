...
/** One evidence entry -> {submission_id, raw_text, normalized_text_en, language}. */
...
/** Per-submission heatmap point -> Hotspot (contract §1). Denser, prettier map. */
export function hotspotFromSubmission({ geo, category, urgency }) {
  return {
    geo: toGeoPoint(geo),
