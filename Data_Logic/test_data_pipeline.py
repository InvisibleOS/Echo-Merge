...
from scoring_v1 import ScoringPipeline

def run_integration_pipeline():
    print("🚀 Starting Echo-Merge Data/Logic Integration Pipeline...")
    ...
    # 5. Run Clustering and Priority Scoring
    scoring = ScoringPipeline(db)
    priorities = scoring.run_priority_generation()
    
    # 6. Export Ranked priorities to JSON (dashboard data contract)
    output_path = os.path.join(project_root, "day1_priorities.json")
